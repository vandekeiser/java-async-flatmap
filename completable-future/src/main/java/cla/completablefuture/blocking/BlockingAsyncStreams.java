...
import static cla.completablefuture.blocking.BlockingAsyncStreams.FlatteningAsyncColectionCollector.flattening;
...
public final class BlockingAsyncStreams {
    ...
    public static <E, F> CompletableFuture<Stream<F>> flatMapAsync(
        ...
        return BlockingAsyncStreams.flatMapAsync(inputs, mapper, parallelisationPool, Stream::empty, Stream::concat);
    }
