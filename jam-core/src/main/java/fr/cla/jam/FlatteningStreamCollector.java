...
import fr.cla.jam.blocking.BlockingAsyncStreams;
...
public class FlatteningStreamCollector<F, Fs extends Stream<F>> implements Collector<
    ...
    CompletableFuture<Fs>
> {
    private final BlockingAsyncStreams.StreamSupplier<F, Fs> streamSupplier;
    private final BinaryOperator<Fs> streamUnion;

    private FlatteningStreamCollector(BlockingAsyncStreams.StreamSupplier<F, Fs> streamSupplier, BinaryOperator<Fs> streamUnion) {
    ...
    public static <F, Fs extends Stream<F>> Collector<CompletableFuture<Fs>, ?, CompletableFuture<Fs>> flattening(
        BlockingAsyncStreams.StreamSupplier<F, Fs> streamSupplier,
