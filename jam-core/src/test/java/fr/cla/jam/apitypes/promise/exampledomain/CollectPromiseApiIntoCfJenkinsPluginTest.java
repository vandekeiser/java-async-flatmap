...
public class CollectPromiseApiIntoCfJenkinsPluginTest extends MeasuringTest {
    ...
    public void should_1_report_bundles_errors() {
        ...
        JenkinsPlugin sut = new CollectPromiseApiIntoCfJenkinsPlugin(jira, newCachedThreadPool());
    ...
    public void should_4_find_the_right_nunmber_of_jira_components() {
        JenkinsPlugin sut = new CollectPromiseApiIntoCfJenkinsPlugin(
    ...
    public void should_5_be_chainable() {
        CfJenkinsPlugin sut = new CollectPromiseApiIntoCfJenkinsPlugin(
            new BlockingLatentPromiseJiraApi(new FakePromiseJiraApi()),
            newCachedThreadPool()
        );
