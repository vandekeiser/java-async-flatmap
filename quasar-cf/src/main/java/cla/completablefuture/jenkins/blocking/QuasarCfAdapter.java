 ...
 * 
 * MAIS:
 * A fiber that is stuck in a loop without blocking, 
 * or is blocking the thread its running on (by directly or indirectly performing a thread-blocking operation) 
 ...
 * whether they’re blocking the thread or hogging the CPU, and gives you their stack trace, 
