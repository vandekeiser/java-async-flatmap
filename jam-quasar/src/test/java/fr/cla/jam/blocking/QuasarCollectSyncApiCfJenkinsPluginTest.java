...
public class QuasarCollectSyncApiCfJenkinsPluginTest extends MeasuringTest {
    ...
    public void should_1_report_bundles_errors() {
        ...
        JenkinsPlugin sut = new QuasarCollectSyncApiCfJenkinsPlugin(jira, newCachedThreadPool());
    ...
    @Test public void should_4_find_the_right_nunmber_of_jira_components() {
        JenkinsPlugin sut = new QuasarCollectSyncApiCfJenkinsPlugin(
    ...
    @Test public void should_5_be_chainable() {
        CfJenkinsPlugin sut = new QuasarCollectSyncApiCfJenkinsPlugin(
            new LatentSyncJiraApi(new FakeSyncJiraApi()),
            newCachedThreadPool()
        );
