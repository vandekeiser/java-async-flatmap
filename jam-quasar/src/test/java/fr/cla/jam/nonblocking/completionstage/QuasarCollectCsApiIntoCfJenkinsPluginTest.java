...
import fr.cla.jam.nonblocking.completionstage.exampledomain.CollectCsApiCfJenkinsPlugin;
import fr.cla.jam.nonblocking.completionstage.exampledomain.QuasarCollectCsApiIntoCfJenkinsPlugin;
...
public class QuasarCollectCsApiIntoCfJenkinsPluginTest extends MeasuringTest {
    ...
    public void should_1_report_bundles_errors() {
        ...
        JenkinsPlugin sut = new QuasarCollectCsApiIntoCfJenkinsPlugin(jira, newCachedThreadPool());
    ...
    @Test public void should_4_find_the_right_nunmber_of_jira_components() {
        JenkinsPlugin sut = new QuasarCollectCsApiIntoCfJenkinsPlugin(
    ...
    @Test public void should_5_be_chainable() {
        CfJenkinsPlugin sut = new QuasarCollectCsApiIntoCfJenkinsPlugin(
            new LatentCsJiraApi(new FakeCsJiraApi()),
            newCachedThreadPool()
        );
